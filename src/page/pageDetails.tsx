    ...
    <div className="w-full h-auto">
      ...
      >
        <div className="absolute w-full z-10 bottom-0 ">
          <div className="lg:w-11/12 w-full mx-auto lg:px-0 p-3 flex gap-3">
            <div className=" lg:w-52 lg:h-80 md:h-68 sm:h-56   xs:h-44 h-40 rounded-md bg-secondary drop-shadow-md">
              <img
      ...
      <div className="w-full h-auto">
        <div className="lg:w-11/12 w-full mx-auto lg:px-0 p-3 flex flex-col gap-4">
