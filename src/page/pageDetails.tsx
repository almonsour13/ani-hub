      ...
      >
        <div className="absolute w-full z-10 bottom-0 ">
          <div className="lg:w-10/12 w-full mx-auto lg:px-0 p-3 py-4 flex gap-3">
            <div className="lg:w-52 md:w-40 sm:w-36 w-32 lg:h-64 md:h-60 sm:h-56 h-48 rounded-md bg-secondary drop-shadow-md">
              <img
            ...
            <div className="w-full relative ">
              <div className="absolute bottom-0 left-0 flex flex-col gap-1">
                <h1 className="leading-none lg:text-5xl md:text-2xl text-2xl text-wrap font-bold  drop-shadow-md">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              {data.Media.genres.map((genre: any) => (
                <a
                  href="#"
                  className="btn lg:btn-sm btn-outline btn-primary rounded leading-none text-xs md:text-base lg:text-md font-bold"
                >
                  {genre}
                </a>
              ))}
